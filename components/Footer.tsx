      ...
      <div className="container px-4 md:px-6">
        <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-4">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-xl">Qemem Cloud</span>
            </div>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Transforming ideas into digital reality with cutting-edge
              Cloudnology solutions.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link
                  href="mailto:hello@qememCloud.com"
                  className="text-gray-500 hover:text-blue-600 dark:hover:text-blue-400"
                >
        ...
        <div className="mt-10 border-t pt-6 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-xs text-gray-500 dark:text-gray-400">
            &copy; {new Date().getFullYear()} Qemem Cloud. All rights reserved.
          </p>
